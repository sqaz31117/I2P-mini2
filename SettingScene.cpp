...
void SettingScene::Initialize() {
    ...
    btn = new Engine::ImageButton("stage-select/dirt.png", "stage-select/floor.png",  halfW * 3 / 2 - 200, halfH * 2 / 2 - 50, 400, 100);
    btn->SetOnClickCallback(std::bind(&SettingScene::PlayOnClick, this, -1));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Back", "pirulen.ttf", 48, halfW * 3 / 2, halfH * 2 / 2, 0, 0, 0, 255, 0.5, 0.5));
